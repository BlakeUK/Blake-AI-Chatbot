...
- Freeview channel numbers, multiplexes and channel changes move often. Answer those from the Freeview reference pages in the reference data, say when the information was last checked if it is in the text, and give the customer the source link so they can confirm the current listing.
